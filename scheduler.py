...
def read_excel():
    Input_excel = pd.read_excel("dataset/Input.xlsx", sheet_name = 'User & Task ID')
...
"""Reading the abnormal predictive guideline price curve predicted from classification.py, 
...
#Defining linear programming algorithms
...
#Generates a bar chart of the the hourly energy usage of this community             
    ...
    exec("plt.savefig('./Desktop/code/plot/Abnormal_Price%s.jpg')"%(z))
    plt.close()
