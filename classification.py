...
price_data = pd.read_csv('dataset/TrainingData.txt', sep=',', names=columns)
...
pred_data = pd.read_csv('dataset/TestingData.txt', sep=',',names=list(map(str, range(24))))
...
#predicted_data.to_csv(os.path.join('dataset', 'TestingResults.txt'),header=False, index=False)
